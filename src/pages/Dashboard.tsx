...
const Dashboard = () => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: `${(stats as any)?.totalPlatformFee?.toLocaleString() || 0} MMK`,
      icon: <DollarSign size={20} />,
      bgColor: 'bg-cyan-50',
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      {isLoading ? (
        <div className="p-12 text-center text-gray-500 bg-white rounded-2xl border border-gray-100 shadow-sm animate-pulse">
