              ...
              <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={parentForm.township}
                    onChange={(e) =>
                      setParentForm({ ...parentForm, township: e.target.value })
                    }
                    className="block w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-primary focus:border-primary"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    value={parentForm.religion}
                    onChange={(e) =>
                      setParentForm({ ...parentForm, religion: e.target.value })
                    }
                    className="block w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-primary focus:border-primary"
                  >
                    <option value="">Select Religion</option>
                  ...
                  {bookingForm.requestedDates.length > 0 ? (
                    <div className="flex flex-wrap gap-1.5">
                      {bookingForm.requestedDates.map((d, i) => (
                        <span
                          key={i}
                          className="inline-flex items-center gap-1 px-2 py-1 bg-primary/10 text-primary rounded-full text-xs font-bold"
                        >
